"""Optional stakeholder review plots.

Plotting imports are lazy so the core pipeline stays usable in solver and CI
environments without geospatial tile dependencies.
"""
