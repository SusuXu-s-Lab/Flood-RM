...
This regeneration splits source acquisition from stochastic design-flood science.

```text
design_events/
  collect_sources/          # source-name I/O only: download/read/write
  ...
  stochastic_boundary/      # science, audit, and event-member layer
...
* `collect_sources/` modules are source-specific I/O adapters only.
* Probability/stochastic logic lives under `stochastic_boundary/`.
