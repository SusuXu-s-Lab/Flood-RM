...
def build_manifest(
    ...
    return {
        ...
        "citations": [
            ...
            "NREL SHIFT, https://www.nrel.gov/research/software/shift-simple-synthetic-distribution-feeder-generation-tool",
            "EPRI OpenDSS, https://opendss.epri.com/IntroductiontoOpenDSS.html",
        ],
    }
