...
def main() -> None:
    ...
    parser.add_argument("--smart-ds-compat-dir", type=Path, default=DEFAULT_SMART_DS_COMPAT_DIR)
    parser.add_argument("--grid-network-dir", type=Path, default=DEFAULT_GRID_NETWORK_DIR)
    parser.add_argument("--output-dir", type=Path, default=DEFAULT_REPORT_DIR)
    args = parser.parse_args()

    report = build_synthetic_validation_report(
        registry_dir=args.registry_dir,
        smart_ds_compat_dir=args.smart_ds_compat_dir,
    ...
    print(f"Wrote {gate_outputs['markdown']}")
