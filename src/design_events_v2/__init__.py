"""design_events_v2 — reference prototype for the Event Catalog.
...
from design_events_v2 import catalog, coastal, diagnostics, inland, probability, records, realization, runtime, timing, workflow
