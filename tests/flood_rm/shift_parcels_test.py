...
from power.baseline_network.source_inputs import fetch_building_parcels_in_geometry
...
def test_fetch_building_parcels_preserves_lon_lat_polygon_order(monkeypatch):
    ...
    monkeypatch.setattr("power.baseline_network.source_inputs.ox.features_from_polygon", fake_features_from_polygon)
