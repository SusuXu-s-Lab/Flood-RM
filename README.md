...
The grid workflow starts by defining a US-based cityL "Marshfield, MA, USA" in config.yaml. Following the notebook process, a synthetic radial distribution feeder via SHIFT/GDM/DiTTo is built and exported into OpenDSS format with the inclusion of an Asset Registry provided by ResStock and ComStock data.
...
### 2. Stochastic Design Events and Flood Truth Set
...
- **Wave-enabled**: quadtree SFINCS with SnapWave and infragravity-wave coupling for coastal truth-set production.
